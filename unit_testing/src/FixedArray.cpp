...
TEST(FixedArrayTest,Constructors){
    ...
    FixedArray<int,25> array_1; // default construct
    FixedArray<float,50,30>::row_major array_2(2.0); // fill construct, specify row major
    FixedArray<double,12,15,90>::col_major array_3(5.0); // fill construct, specify col major
...
TEST(FixedArrayTest,Iteration){
    FixedArray<int,10,5,20>::row_major row_array(0);
    FixedArray<int,10,5,20>::col_major col_array(0);
    int count;
